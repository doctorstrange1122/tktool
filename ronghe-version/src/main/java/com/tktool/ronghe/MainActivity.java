...
public class MainActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // 加载线上网页，实时更新，加时间戳防缓存
        webView.loadUrl("https://doctorstrange1122.github.io/huafei/super/index.html?v=" + System.currentTimeMillis());
    }
            ...
            runOnUiThread(new Runnable() {
                ...
                public void run() {
                    if ("com.tmall.wireless".equals(packageName)) {
                        ...
                        openRongheAlipay(url);
                    } else {
                        openRongheTaobao(url);
                    }
                }
            });
        }
    ...
    // 跳转淘宝APP
    private void openRongheTaobao(String url) {
        try {
    ...
    // 跳转天猫APP
    private void openRongheTmall(String url) {
        try {
    ...
    // 跳转支付宝APP
    private void openRongheAlipay(String url) {
        try {
