...
KEYSTORE="$OUT_DIR/quick_v1.keystore"
KEYSTORE_PASS="quick2026"
KEY_ALIAS="quick_v1"
KEY_PASS="quick2026"
...
javac -source 1.8 -target 1.8 \
    ...
    "$SRC"/java/com/tktool/quick/*.java "$OUT_DIR"/gen/com/tktool/quick/R.java 2>/dev/null || \
javac -source 1.8 -target 1.8 \
    -bootclasspath /usr/lib/jvm/java-8-openjdk-amd64/jre/lib/rt.jar \
    -cp "$ANDROID_JAR:$ZXING_JAR" \
    -d "$OUT_DIR/java_classes" \
    "$SRC"/java/com/tktool/quick/*.java
echo "       编译完成"
